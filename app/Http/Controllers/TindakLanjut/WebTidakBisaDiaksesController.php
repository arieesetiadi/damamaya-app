...
class WebTidakBisaDiaksesController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('web-tidak-bisa-diakses-tindak.index')->with('success', 'Berhasil Melakukan Tindak Lanjut');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('web-tidak-bisa-diakses-tindak.index')->with('success', 'Berhasil Menghapus Data Tindak Lanjut');
    }
