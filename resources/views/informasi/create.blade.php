        ...
        <div class="card-body">
            <form action="{{ route('informasi.store') }}" method="POST">
                ...
                <div class="mt-3">
                    ...
                    <input id="nama_pd" name="nama_pd" class="form-control  @error('nama_pd')  border-danger @enderror"
                        type="text" placeholder="Instansi" value="{{ old('nama_pd') }}">
                    @error('nama_pd')
                ...
                <div class="my-3">
                    ...
                    <input id="tahun_update" name="tahun_update"
                        class="form-control  @error('tahun_update')  border-danger @enderror" type="text"
